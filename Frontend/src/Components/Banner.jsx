...
const Banner = () => {
  return (
    <>
      <div className=" max-w-screen-xl mx-auto container px-7 md:px-20 sm:px-4 my-20 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2 ">
            <img src={banner} className="w-92 h-92 md:size-80 md:mt-32 md:mx-auto" alt="" />
        </div>
      </div>
    </>
  );
